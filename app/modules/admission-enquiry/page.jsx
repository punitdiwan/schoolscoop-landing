...
import AdmissionContent from "./ModuleContent"
import AdmissionFeatureCardSection from "./FeatureCard"
const Admission = () =>{
    return (
        <>
              <div>
          ...
          <div className="-m-6 max-h-[768px] w-[calc(100%+48px)]  overflow-auto scrollbar-hide ">
            ...
            <div className="mx-auto p-2 ">
             ...
             <AdmissionContent></AdmissionContent>
              <AdmissionFeatureCardSection></AdmissionFeatureCardSection>
              <Footer />
            </div>
          </div>
        </div>
