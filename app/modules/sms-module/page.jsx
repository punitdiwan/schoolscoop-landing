...
import SmsModuleContent from "./ModuleContent"
import SmsFeatureCardsSection from "./FeartureCard"
const SmsModule = () =>{
    return (
        <>
              <div>
        ...
        <div className="p-[20px]">
          <div className="-m-6 max-h-[768px] w-[calc(100%+48px)]  overflow-auto scrollbar-hide ">
            ...
            <div className="mx-auto p-2 ">
             ...
             <SmsModuleContent></SmsModuleContent>
              <SmsFeatureCardsSection></SmsFeatureCardsSection>
              <Footer />
            </div>
          </div>
        </div>
