...
const TranspotFeature = () => {
  return (
   <>
        <div>
        <div>
            <div><h1 className='text-[#2c5aa0] text-[40px] font-bold text-center'>fg Explore Other SchoolScoop Features</h1></div>
        ...
        <div className="grid md:grid-cols-5 gap-7 p-12 ">
            <div className="">
             ...
             dg   A single dashboard that enables digital transformation & change the way you deliver education.
              </div>
              <div>
