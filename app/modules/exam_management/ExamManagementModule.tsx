          ...
          <div>
            <div className="grid md:grid-cols-2 gap-7 p-12 ">
              <div className="">
                ...
                Whether you need to manage one institute or a hundred, Edumarshal school management erp allows you to monitor & manage your institutes from a single dashboard with absolute ease. Set up granular controls 
                and use extensive reporting features to get instant insights on performance.
                </div>
                <div>
              ...
              <div className="">
                ...
                <div className="text-center text-[14px] text-[#999999]">
                Edumarshal not only offers key user-roles – Administrator, Staff, Teachers, Parents & Students – but also allows you to further define data & service access for highly granular user access contorls that help you ensure 
                higher accountability and restrict access to sensitive content.
                </div>
                <div>
                  <div className=" text-[#DD9933] text-center flex justify-center">
                    <IoMdPlayCircle className="mt-1" />
          ...
          <div className="p-[50px]">
            ...
            <div className="grid md:grid-cols-2 gap-7 p-12 ">
              <div className="">
                ...
                <div className="text-center text-[14px] text-[#999999]">
                A rich and flexible toolset enables both teachers and administrative staff to manage even 
                thousands of students in hundreds of batches,
                 courses, classes across multiple institutes with absolute ease.
                </div>
                <div>
                  <div className=" text-[#DD9933] text-center flex justify-center">
                    <IoMdPlayCircle className="mt-1" />
