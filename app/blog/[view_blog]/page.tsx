            ...
            <div className="p-12">
              <div className="grid grid-cols-1 mx-auto ">
                ...
                {filteredEntries.map((entry) => (
                  <div> 
                    <div><h1 className="text-center font-bold text-4xl">{entry?.blog_title}</h1></div>
                    <div > <img src={entry?.blog_image?.data?.full_url} className="mx-auto  sm:w-[550px] sm:h-[330px] mt-3"/></div>
